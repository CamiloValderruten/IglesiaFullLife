...
return [
    ...
    'section' => [
        ...
        'google_fonts' => [
            'variants' => [
                'label' => 'Variants',
                'description' => 'Add a comma separated list of font weights to load, e.g. 300, 400, 600. Look up available variants at <a href="https://fonts.google.com" target="_blank">Google Fonts</a>.',
                'attrs' => [
                    'placeholder' => '400',
                    'lazy' => true,
                ],
            ...
            'subsets' => [
                'label' => 'Languages',
                'description' => 'Add a comma separated list of font subsets to load, e.g. cyrillic, cyrillic-ext, greek, greek-ext, latin-ext, vietnamese. The Latin subset is always included. Look up available subsets at <a href="https://fonts.google.com" target="_blank">Google Fonts</a>.',
                'attrs' => [
                    'placeholder' => 'latin',
                    'lazy' => true,
                ],
        ...
        'hover' => [
            ...
            'utility' => '.uk-panel-scrollable, .uk-height-small, .uk-height-medium, .uk-height-large, .uk-dropcap, .uk-logo',
        ...
        'inspect' => [
            ...
            'utility' => '.uk-panel-scrollable, .uk-panel-scrollable > *, .uk-height-small, .uk-height-small > *, .uk-height-medium, .uk-height-medium > *, .uk-height-large, .uk-height-large > *, .uk-dropcap, .uk-logo, .uk-logo > *',
